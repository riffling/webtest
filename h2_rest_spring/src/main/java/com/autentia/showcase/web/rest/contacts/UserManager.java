...
@Controller
@RequestMapping(value = "/users", produces = JSON)

public class UserManager {
    @RequestMapping(value = "/fetchUserById", method = RequestMethod.GET, produces = "text/plain")
    @ResponseBody
    public String fetchUserByID(@RequestParam(required = false, defaultValue = "This is the default message") String msg) {return null;}
